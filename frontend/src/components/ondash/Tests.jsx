      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Choose your test category and challenge yourself with our
              ...
              >
                <div className="relative overflow-hidden rounded-2xl bg-white border border-gray-200 h-64 hover:border-gray-300 transition-colors duration-300">
                  ...
                  <div className="relative p-8 h-full flex flex-col">
                    <div
                      className={`mb-6 p-3 rounded-xl bg-gradient-to-br ${topic.color} w-fit group-hover:scale-110 transition-transform duration-300`}
                    >
                  ...
                  <div
                    className={`absolute top-4 right-4 w-2 h-2 rounded-full opacity-20 bg-gradient-to-br ${topic.color}`}
                  ></div>
                  <div
                    className={`absolute top-8 right-8 w-1 h-1 rounded-full opacity-30 bg-gradient-to-br ${topic.color}`}
                  ></div>
                </div>
              </div>
            );
        ...
        <div className="text-center mt-16 text-gray-500">
          <p className="text-sm">
            Each test contains 5 multiple-choice questions • Estimated time:
            10-15 minutes
          </p>
        </div>
      </div>
